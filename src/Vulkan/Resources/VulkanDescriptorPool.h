...
namespace tiny_vulkan {
	...
	{
	public:
		explicit VulkanDescriptorPool(VkDevice device, VkDescriptorPool pool);
		~VulkanDescriptorPool() = default;

		[[nodiscard]] std::shared_ptr<VulkanDescriptorSet> AllocateSet(VkDescriptorSetLayout setLayout);
		void Reset();
	...
	{
	public:
		explicit DescriptorPoolBuilder() = default;
